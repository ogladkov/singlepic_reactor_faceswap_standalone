...
from components.r_facelib.detection import init_detection_model
from components.r_facelib.parsing import init_parsing_model
from components.r_facelib.utils.misc import img2tensor, imwrite
...
class FaceRestoreHelper(object):
    ...
    def __init__(self,
        ...
        self.face_parse = init_parsing_model(cfg=self.cfg, device=self.device)
